...
Deno.serve(async (req) => {
  ...
  try {
    ...
    return responder({ imagem_base64: imagem, formato: "image/webp", pedido_id: pedidoId, aviso: "Prévia GPT com referências: confira primeiro limites, quantidade e localização; depois avalie a aparência." });
  } catch (erro) {
