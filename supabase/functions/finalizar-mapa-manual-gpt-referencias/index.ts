...
Deno.serve(async (req) => {
  ...
  try {
    ...
    formulario.append("prompt", [
      ...
      "Crie profundidade por sombreamento dentro dos contornos e sombras suaves na própria borda de contato, sem aumentar o volume anatômico representado. A lesão deve parecer ligada à superfície em que foi posicionada, sem halo ou contorno de recorte.",
