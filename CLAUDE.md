...
- Nenhuma chave secreta, senha ou token dentro do código que vai para o navegador do usuário. Segredo vive no servidor.
- Tudo tem que funcionar primeiro no celular. O meu público vive no telefone.

# O PROJETO

- A especificação do que estamos construindo está no arquivo ESPEC.md. Leia antes de propor qualquer coisa.
