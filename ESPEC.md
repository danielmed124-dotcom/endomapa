...
Correção das vistas no editor manual (24/09/2026): a escolha **Coronal**, **Sagital** ou **Ambas** passa a controlar também a montagem manual, com seleção sincronizada entre Novo mapa e Editor manual. Em Ambas, os dois mapas aparecem e o médico escolhe qual editar. Cada vista mantém suas próprias lesões, posições, nomes e medidas enquanto a aba permanece aberta; não há cópia ou conversão automática de posições entre vistas. Selecionar uma lesão ativa a vista correspondente. Limpar e baixar atuam somente na vista em edição, identificada nos botões; cada download PNG usa sua base anatômica e a identidade do médico. Essa correção substitui a limitação coronal da transferência anterior. A escolha também atualiza imediatamente as vistas da revisão do ditado.
